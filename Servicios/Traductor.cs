    ...
    public class Traductor
    {
        ...
        public Hashtable Traducir(string idioma)
        {
            ...
            if (idioma == "Esp")
            {
                ...
                traducciones.Add("BOTON_ACTUALIZAR_DATOS_CUENTA", "Actualizar Datos de Cuenta");
                traducciones.Add("BOTON_ACTUALIZAR_PSW", "Actualizar Contraseña");
                traducciones.Add("BOTON_AGREGAR_CARRITO", "Agregar al Carrito");
                traducciones.Add("BOTON_ALTA_USR_ADMINISTRATIVO", "Alta Usuario Administrativo");
                traducciones.Add("BOTON_BLOQUEAR_CUENTA", "Bloquear Cuenta");
                traducciones.Add("BOTON_CATALOGO", "Catálogo");
                traducciones.Add("BOTON_COMPRAR", "Realizar Compra");
                traducciones.Add("BOTON_DESBLOQUEAR_CUENTA", "Desbloquear Cuenta");
                traducciones.Add("BOTON_ELIMINAR_CUENTA", "Eliminar Cuenta");
                ...
                traducciones.Add("BOTON_QUITAR_PRODUCTO", "Quitar Producto");
                traducciones.Add("BOTON_RECUPERAR_PSW", "Recuperar Contraseña");
                ...
                traducciones.Add("CUENTA_ACTUALIZARDATOS_BOTON_GUARDAR", "Guardar Cambios");
                ...
                traducciones.Add("CUENTA_DETALLE_TITULO", "Datos de Mi Cuenta");
                ...
                traducciones.Add("PRODUCTO_CARRITO_TITULO", "Productos en el Carrito");
            ...
            if (idioma == "Eng")
            {
                ...
                traducciones.Add("BOTON_ACTUALIZAR_DATOS_CUENTA", "Update Account Data");
                traducciones.Add("BOTON_ACTUALIZAR_PSW", "Update Password");
                traducciones.Add("BOTON_AGREGAR_CARRITO", "Add to Cart");
                traducciones.Add("BOTON_ALTA_USR_ADMINISTRATIVO", "New Administrative User");
                traducciones.Add("BOTON_BLOQUEAR_CUENTA", "Block Account");
                traducciones.Add("BOTON_CATALOGO", "Catelogue");
                traducciones.Add("BOTON_COMPRAR", "Buy");
                traducciones.Add("BOTON_DESBLOQUEAR_CUENTA", "Unlock account");
                traducciones.Add("BOTON_ELIMINAR_CUENTA", "Delete account");
                traducciones.Add("BOTON_ENVIAR", "Send");
                traducciones.Add("BOTON_FINALIZAR", "Finalize");
                traducciones.Add("BOTON_PERMISOS", "See Permissions");
                traducciones.Add("BOTON_QUITAR_PRODUCTO", "Remove");
                traducciones.Add("BOTON_RECUPERAR_PSW", "Recover password");
                ...
                traducciones.Add("CUENTA_ACTUALIZARDATOS_BOTON_GUARDAR", "Save Changes");
                ...
                traducciones.Add("CUENTA_DETALLE_TITULO", "My Account Information");
                ...
                traducciones.Add("CUENTA_RECUPERAR_PSW_TITULO", "Recover password");
                ...
                traducciones.Add("EXCEPCIONES_INDEX_TITULO", "Excuse me, we had a problem. Please contact an administrator.");
                ...
                traducciones.Add("HOME_CONTACTO_TITULO", "Contact");
                traducciones.Add("HOME_CONTACTO_TITULO_2", "Tell us what you think about!");
                ...
                traducciones.Add("HOME_TITULO_FOLLETO", "Virtual News Bulletin");
                ...
                traducciones.Add("PRODUCTO_CARRITO_TITULO", "Products in the Cart");
